...
if("TRUE" STREQUAL "TRUE")
  set(sjtu_drone_SOURCE_PREFIX /home/monojit/simulation_ws/src/parrot_ardrone/sjtu-drone)
  set(sjtu_drone_DEVEL_PREFIX /home/monojit/simulation_ws/devel)
  ...
  set(sjtu_drone_INSTALL_PREFIX /home/monojit/simulation_ws/install)
...
if(NOT "/home/monojit/simulation_ws/src/parrot_ardrone/sjtu-drone/include " STREQUAL " ")
  set(sjtu_drone_INCLUDE_DIRS "")
  set(_include_dirs "/home/monojit/simulation_ws/src/parrot_ardrone/sjtu-drone/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sjtu_drone' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/monojit/simulation_ws/src/parrot_ardrone/sjtu-drone/${idir}'.  ${_report}")
    endif()
