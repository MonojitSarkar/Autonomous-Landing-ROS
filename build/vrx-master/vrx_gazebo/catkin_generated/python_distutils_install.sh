...
echo_and_run cd "/home/monojit/simulation_ws/src/vrx-master/vrx_gazebo"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/monojit/simulation_ws/src/vrx-master/vrx_gazebo/setup.py" \
     \
    build --build-base "/home/monojit/simulation_ws/build/vrx-master/vrx_gazebo" \
    install \
    --root="${DESTDIR-/}" \
